...
//    }
    ...
    public String products(Model model) {
        String url = "https://undisturbed-scarecrow-production.up.railway.app/api/product/list";
    ...
    public String detail(@PathVariable(value = "id") Long id , Model model) {
        String url = "https://undisturbed-scarecrow-production.up.railway.app/api/product/detail/"+id;
        RestTemplate restTemplate = new RestTemplate();
