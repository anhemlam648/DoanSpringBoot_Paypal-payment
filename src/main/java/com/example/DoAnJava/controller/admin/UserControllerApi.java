...
public class UserControllerApi {
    ...
    public String getView(@PathVariable(value = "id") Long id,Model model) {
        String url = "https://undisturbed-scarecrow-production.up.railway.app/authent/detail/"+id;
    ...
    {
        String url = "https://undisturbed-scarecrow-production.up.railway.app/authent/list";
