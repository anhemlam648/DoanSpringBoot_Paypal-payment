...
public class OrdersControllerApi {
    ...
    public String getView(@PathVariable(value = "id") Long id,Model model) {
        String url = "https://undisturbed-scarecrow-production.up.railway.app/orders/detail/"+id;
    ...
    {
        String url = "https://undisturbed-scarecrow-production.up.railway.app/orders/list";
